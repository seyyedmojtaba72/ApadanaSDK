...
import com.github.seyyedmojtaba72.apadana_sdk_android.Apadana;
...
public class EndPoints {
    ...
    private Apadana mApadana;

    public EndPoints(Context context) {
        this.mContext = context;
        mApadana = new Apadana(context);
    }

    public String getApiUrl() {
        return mApadana.getHomeUrl() + "/rest?";
    }

    public String getProfileImagesUrl() {
        return mApadana.getSystemUrl() + "/contents/uploads/profile_images";
    }

    public String generateHash(String url) {
        return url + "&hash=" + Encryption.md5(url + mApadana.getSecretKey());
    }
